...
# =========
nextLocationIndex=0
robotMotor=None			# Doesnt fucking work
compass=None
robotGps=None
...
def main():
	...
	while nextLocationIndex < len(locations):
		...
		# # os.system("clear")
		try:
			print("Move Forward", robotGps.getGpsData(), locations[nextLocationIndex] ,slope, compass.getCompassAngle())
